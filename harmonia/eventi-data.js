...
window.HARMONIA_EVENTI = [
  ...
  { date:'2026-07-10', title:'Harmonia Fondi',          sub:'Gaeta', lineup:'Archie Hamilton · Luigi Landolfo · Roberto Morra', foto:'loc-fondi-gaeta', around:'Fondi · Gaeta' },
  { date:'2026-07-18', title:'Harmonia Ischia',         sub:'in collaborazione con Atarashi', lineup:'DJ Tennis · Chris Bowl · Luigi Landolfo', foto:'people-5', around:'Ischia' },
  ...
  { date:'2026-02-13', title:'Duel',             sub:'Napoli',    lineup:'Kidoo · Elbio & Denis · Chris Bowl · Claudio Pascale', foto:'loc-duel-napoli-2026-02-13', around:'Duel · Napoli' },
  { date:'2026-02-27', title:'The Circle',       sub:'Roma',      lineup:'Joey Daniel · Luigi Landolfo · Gianluca Luciani', foto:'loc-the-circle-roma-2026-02-27', around:'The Circle · Roma' },
  ...
  { date:'2026-04-25', title:'Maya',             sub:'Sorrento',  lineup:'Chelina Manuhutu · Alessio Cristiano · Claudio Pascale · Cristian Volpe · Julia', foto:'loc-maya-sorrento-2026-04-25', around:'Maya · Sorrento' },
...
window.harmoniaAround = function () {
  var s = window.HARMONIA.split();
  var a = s.upcoming.slice(0, 2).map(function (e) { var o = Object.assign({}, e); o.soon = true; return o; })
    .concat(s.past.slice(0, 6).map(function (e) { var o = Object.assign({}, e); o.soon = false; return o; }));
